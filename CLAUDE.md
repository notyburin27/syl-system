...
This project is indexed by GitNexus as **syl-system** (2379 symbols, 3222 relationships, 29 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
